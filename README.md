...
- ошибка если зона с таким title уже сущесвует
...
- список с найдеными по координатам зонами доставки, если переданы координаты которые входят хотя бы в одну зону
- ошибка если запрос не проходит валидацию
